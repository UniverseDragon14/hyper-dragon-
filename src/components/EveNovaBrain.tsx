...
export const EveNovaBrain: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('EVE NOVA memory load failed', error);
    }
  }, []);
  ...
  useEffect(() => {
    ...
    recognition.onerror = () => {
      ...
      setMessages((previous) => [
        ...
        {
          role: 'assistant',
          text: 'Voice signal fail aachu. Type pannunga, EVE NOVA ready.',
          timestamp: Date.now(),
        },
      ]);
    };
  ...
  const adapterLabel = online ? 'PRIVATE_CORE' : 'CORE_OFFLINE';
